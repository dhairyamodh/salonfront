...
export const NoCartBag = () => {
  const { primaryColor: a, secondaryColor: b } = useSelector(
    (state) => state.shop.salonData
  );


  const primaryColor = b;
  const secondaryColor = a;
  ...
  return (
    ...
    >
      <defs>
        ...
        >
          <stop offset="0" stopColor={primaryColor || "#006854"} />
          <stop offset="1" stopColor={secondaryColor || "#009e7f"} />
        </linearGradient>
      </defs>
      <g
        id="no_cart_in_bag_2"
